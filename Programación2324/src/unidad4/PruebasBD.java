...
public class PruebasBD {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/**
			 * Funciones interesantes con resulset rs.previous() hacia atras
			 * rs.getFetchSize() cantidad de elementos rs.beforeFirst() lo mueve al
			 * principio rs.afterLast() lo mueve al final rs.getArray(column) devuelve todos
			 * los datos de una columna en un array
			 */
			...
			rs = ModelCliente.getClientes(con);
