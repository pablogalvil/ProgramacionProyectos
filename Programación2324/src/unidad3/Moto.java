...
public class Moto extends Vehiculo {
	...
	public Moto(int presionRuedas, String tipoMoto, double peso, int pulgadaLlanta) {
		super();
		this.presionRuedas = presionRuedas;
		this.tipoMoto = tipoMoto;
		this.peso = peso;
		this.pulgadaLlanta = pulgadaLlanta;
		// Desde la clase hija se puede acceder a las variables y metodos de la clase
		// padre. Tanto los metodos publicos como los protegidos
